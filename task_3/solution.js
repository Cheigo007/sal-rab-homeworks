function renderCartItem(item) {
    ...
    // Предыдущие 4 строки можно объединить в одну. Это и сделано ниже:
    
    itemCountText = itemCountText + product.count   // 2. Присвойте переменной itemCountText результат склеивания itemCountText и количества
                                  + ` × `           // 3. Присвойте переменной itemCountText результат склеивания itemCountText и ` × `
                                  + product.price   // 4. Присвойте переменной itemCountText результат склеивания itemCountText и цены
